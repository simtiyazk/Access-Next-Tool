...
const config = {
   ...
   veeva: {
      ...
      //	}
      key_messages: {
         access_next_tool_00_00: {
            description: ""
         },
         access_next_tool_10_00: {
            description: ""
         },
         access_next_tool_20_00: {
            description: ""
         },
         access_next_tool_30_00: {
            description: ""
         },
         access_next_tool_40_00: {
            description: ""
         },
         access_next_tool_50_00: {
            description: ""
         },
         access_next_tool_60_00: {
            description: ""
         },
         access_next_tool_70_00: {
            description: ""
         },
         //shared key message
         shared: {
...
gulp.task('build', function (cb) {
  $.sequence('build:ctl', 'build:html', 'build:styles', 'build:scriptsG', 'build:images', 'build:extras', 'zip', cb);
})
