...
export default () => {
	...
	//private
	var self, el, nextButton, headerNav1, headerNav2, headerNav3, headerNav4, headerNav5, references, referencesClose, runningInVeeva, openPopupFunction, openPopupComposition, closeBtnPopupFunction, closeBtnPopupComposition, closeContainerPopup, touchclick = ('ontouchend' in document.documentElement) ? 'touchend' : (window.navigator.pointerEnabled) ? 'pointerup' : 'click';
