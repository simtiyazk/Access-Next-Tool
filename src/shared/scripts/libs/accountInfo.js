...
function displayfieldsByVeeva() {
	...
	function displayVeevaAccname() {
		...
		// com.veeva.clm.getDataForCurrentObject("Account", "Name", getNameofAccount);
   
		// function getNameofAccount(result) {
		// 	if (result.success == true) {
		// 		$("#customerAccountName,.notifi_content_container h2").text(result.Account.Name);
		// 	}
		// }
...
//setTimeout(function(){ displayVeevaAccname(); }, 300);
setTimeout(function(){ displayfieldsByVeeva(); }, 300);